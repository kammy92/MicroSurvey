...
public class AppConfigTags {
    ...
    public static final String HEADER_USER_LOGIN_ID = "user-login-id";
    ...
    public static final String CATEGORIES_NAME="category_name";
    public static final String SUB_CATEGORIES = "sub_categories";
    public static final String SUBCATEGORIES_ID="sub_category_id";
    public static final String SUBCATEGORIES_NAME="sub_category_name";
